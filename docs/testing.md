...
- **Контекст авторизации** — в части тестов страниц/навигации используется реальный `AuthSessionProvider` и мок `fetch`; в других — мок `useAuthSessionContext` для изоляции UI.
